...
@onready var search_input = $VBoxContainer/Header/Controls/SearchInput
@onready var addon_count_label = $VBoxContainer/Header/Controls/AddonCountLabel
@onready var refresh_button = $VBoxContainer/Header/Controls/RefreshButton

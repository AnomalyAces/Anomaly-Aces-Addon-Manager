...
const DEPENDENCY_ENTRY_SCENE = preload("res://addons/aceAddonManager/Scenes/AddonDependencyEditor/DependencyEntry/dependency_entry.tscn")
...
func _on_run_script_pressed() -> void:
	...
	var script_path = project_root + "manage_addons"
	var output: Array = []
	...
	if exit_code == 0:
		...
		var cmd = "bash ./manage_addons update"
